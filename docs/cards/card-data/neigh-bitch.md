...
Functionally identical to Hell Neigh! and The Safeword is Neigh. Standard counter/interrupt, handled by `NeighManager` (see CLAUDE.md). Rolled into `BasicNeighCardData` (`NeighType.Basic`) via `cardNameVariations`.
