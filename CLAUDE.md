...
- `PendingActionType`: `None`, `DiscardCard`, `GiveCard`, `DestroyCard`, `DestroyUnicornCard`, `StealCard`, `PlayCardFromHand`, `SacrificeCard`, `TakeFromHand`
